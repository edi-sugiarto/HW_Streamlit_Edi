...
def cache_prediction(X_test, _model, _model_nr):
    ...
    return y_test_pred_pkl, y_test_pred_proba_pkl, y_test_pred_nr, y_test_pred_proba_nr

y_test_pred_pkl, y_test_pred_proba_pkl, y_test_pred_nr, y_test_pred_proba_nr = cache_prediction(X_test, model, model_nr)
